...
(function(){
    ...
    (function() {
    var p = "2760880", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2760880||'',
    GUID:window.ftGUID_2760880||'99999999999',
    confID:window.ftConfID_2760880||'0',
    ftReturn: window.ftReturn_2760880||'',
    keyword:window.ftKeyword_2760880||'',
    ftId:window.ftId_2760880||'',
    imp:window.ftImp2760880,
    ftImpId:window.ftImp2760880 && window.ftImp2760880.impID || '',
    campaignID:'83682',
    cID:'85010',
    pID:'2760880',
    creativeID:'2075289',
    exttrack:["https://ad.doubleclick.net/ddm/trackimp/N6344.148818.AMAZON.COMAMAZONMED/B20357426.206386621;dc_trk_aid=409634862;dc_trk_cid=95670962;ord=[timestamp];dc_lat=;u=[%FT_IMPRESSIONID%]_[FT_GUID];dc_rdid=;tag_for_child_directed_treatment=?"],
    extscript:["https://log.dmtry.com/redir/1/3728/4062/1426840/0/1/185/0/1013/1.ver?at=i&d=PxImp&img=1[nocachebuster]","https://cdn.doubleverify.com/dvtp_src.js?ctx=1000798&cmp=83682&sid=444&plc=2760880&num=&adid=&advid=1487&adsrv=29&region=30&btreg=/2760880/&btadsrv=flashtalking&crt=2075289&crtname=&chnl=&unit=&pid=&uid=&tagtype=&dvtagver=6.1.src"],
    clickTags: ["http://servedby.flashtalking.com/click/8/83682;2760880;2075289;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ad.doubleclick.net/ddm/trackclk/N6344.148818.AMAZON.COMAMAZONMED/B20357426.206386621;dc_trk_aid=409634862;dc_trk_cid=95670962;dc_lat=;u=[%FT_IMPRESSIONID%]_[FT_GUID];dc_rdid=;tag_for_child_directed_treatment="],
    placementDescription:'AMAZONAAPAAPQ1PackagewithCustomTargeting300x250FLASHTALKING1x1NASSOTHMULNAPKCFVT',
    width:300,
    height:250,
    adType:'HTML_onpage'.toLowerCase(),
    siteName:'AmazonMediaGroup',
    divID:'ftdiv2760880',
    phID:'ftpos2760880',
    frameID:'ftframe2760880',
    expID:'ftexpframe2760880',
    altImgID:'ftalt2760880',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/83682;2760880;2075289;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ad.doubleclick.net/ddm/trackclk/N6344.148818.AMAZON.COMAMAZONMED/B20357426.206386621;dc_trk_aid=409634862;dc_trk_cid=95670962;dc_lat=;u=[%FT_IMPRESSIONID%]_[FT_GUID];dc_rdid=;tag_for_child_directed_treatment=',
    altImg:'http://servedby.flashtalking.com/imp/8/83682;2760880;204;gif;AmazonMediaGroup;AMAZONAAPAAPQ1PackagewithCustomTargeting300x250FLASHTALKING1x1NASSOTHMULNAPKCFVT/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/83682;2760880;271;pixel;AmazonMediaGroup;AMAZONAAPAAPQ1PackagewithCustomTargeting300x250FLASHTALKING1x1NASSOTHMULNAPKCFVT/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/83682;2760880;207;guid;AmazonMediaGroup;AMAZONAAPAAPQ1PackagewithCustomTargeting300x250FLASHTALKING1x1NASSOTHMULNAPKCFVT/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/276/2760880/2075289/js/j-2760880-2075289.js',
    file:'http://cdn.flashtalking.com/85010/2075289/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?101223627-2760880;2075289;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_2760880||'',
    segmentList:window.ftSegmentList_2760880||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2760880 && window.ftImp2760880.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2760880')&&/^https:/.test(document.getElementById('ftscript_m2760880').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2760880'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2760880'],
        ['ftcfid', 'ftConfID_2760880'],
        ['fttime', 'ftTimestamp_2760880'],
        ['ftsection', 'ftSection_2760880'],
        ['ftcustom', 'ftCustom_2760880'],
        ['ft_id', 'ftId_2760880'],
        ['ftimpid','ftImp2760880', 'impID']
    ]
};
